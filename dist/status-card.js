 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ie, defineProperty: je, getOwnPropertyDescriptor: Be, getOwnPropertyNames: Re, getOwnPropertySymbols: Fe, getPrototypeOf: Ne } = Object, Q = globalThis, re = Q.trustedTypes, Ue = re ? re.emptyScript : "", Rt = Q.reactiveElementPolyfillSupport, bt = (e, t) => e, kt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ue : null;
      break;
  ...
  return i;
} }, Yt = (e, t) => !Ie(e, t), le = { attribute: !0, type: String, converter: kt, reflect: !1, useDefault: !1, hasChanged: Yt };
...
let ft = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(bt("properties"))) {
      const i = this.properties, s = [...Re(i), ...Fe(i)];
...
ft.elementStyles = [], ft.shadowRootOptions = { mode: "open" }, ft[bt("elementProperties")] = /* @__PURE__ */ new Map(), ft[bt("finalized")] = /* @__PURE__ */ new Map(), Rt == null || Rt({ ReactiveElement: ft }), (Q.reactiveElementVersions ?? (Q.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $t = globalThis, Dt = $t.trustedTypes, ce = Dt ? Dt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Ce = "$lit$", Y = `lit$${Math.random().toFixed(9).slice(2)}$`, xe = "?" + Y, Ve = `<${xe}>`, ct = document, wt = () => ct.createComment(""), At = (e) => e === null || typeof e != "object" && typeof e != "function", Jt = Array.isArray, qe = (e) => Jt(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ft = `[ 	
\f\r]`, vt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, de = /-->/g, he = />/g, st = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
    ...
    for (; (o = at.nextNode()) !== null && r.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(Ce)) {
          ...
          r.push({ type: 1, index: n, name: f[2], strings: p, ctor: f[1] === "." ? Ze : f[1] === "?" ? Ye : f[1] === "@" ? Je : Lt }), o.removeAttribute(h);
...
let We = class {
  ...
  u(t) {
    ...
    for (; r !== void 0; ) {
      if (a === r.index) {
        let c;
        r.type === 2 ? c = new gt(n, n.nextSibling, this, t) : r.type === 1 ? c = new r.ctor(n, r.name, r.strings, this, t) : r.type === 6 && (c = new Xe(n, this, t)), this._$AV.push(c), r = s[++l];
      }
...
const Qe = { I: gt }, Nt = $t.litHtmlPolyfillSupport;
Nt == null || Nt(Et, gt), ($t.litHtmlVersions ?? ($t.litHtmlVersions = [])).push("3.3.1");
const ti = (e, t, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ke = "important", ri = " !" + ke, Ct = Ht(class extends Pt {
  constructor(e) {
    var t;
...
function Te(e, t, i, s, o, n) {
  const a = o.area && o.area.length ? o.area : null, l = o.floor && o.floor.length ? o.floor : null, r = o.label && o.label.length ? o.label : null, c = o.hiddenAreas || [], d = o.hiddenLabels || [], h = o.hiddenEntities || [], u = new Set(c), p = new Set(d), f = new Set(h), b = new Map(t.map((y) => [y.id, y])), m = new Map(
    ...
    if (!(y.area_id != null || v && v.area_id != null) || r && !((((z = y.labels) == null ? void 0 : z.some((G) => r.includes(G))) ?? !1) || (((D = v == null ? void 0 : v.labels) == null ? void 0 : D.some((G) => r.includes(G))) ?? !1)) || a && !(y.area_id !== void 0 && y.area_id !== null && a.includes(y.area_id) || v && v.area_id !== void 0 && v.area_id !== null && a.includes(v.area_id)))
      return !1;
    if (l) {
      const N = y.area_id ? m.get(y.area_id) : void 0, G = v != null && v.area_id ? m.get(v.area_id) : void 0;
      if (!(N && l.includes(N) || G && l.includes(G))) return !1;
    }
    return u.size && (y.area_id && u.has(y.area_id) || v && v.area_id && u.has(v.area_id)) || (M = y.labels) != null && M.some((N) => p.has(N)) || f.has(y.entity_id) ? !1 : !y.hidden_by && !y.disabled_by;
  }).map((y) => y.entity_id), C = {};
  for (const y of _) {
...
const R = (lt = class extends V {
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return n.sort((r, c) => {
            ...
            if (d !== h) return d - h;
            const u = B(r.entity_id), p = B(c.entity_id), f = this.hass ? I(this.hass, r.state, u) : r.state, b = this.hass ? I(this.hass, c.state, p) : c.state, m = (f || "").localeCompare(b || "");
  ...
  render() {
    var g, v, F, z, D, M, N, G, Bt, ie, se, oe;
    if (!this.open) return $``;
    const t = (g = this.card) != null && g.list_mode ? 1 : ((F = (v = this.card) == null ? void 0 : v._config) == null ? void 0 : F.columns) || 4, i = this.selectedDomain, s = this.selectedDeviceClass, o = this.selectedGroup, n = this.card, l = (typeof (n == null ? void 0 : n._shouldShowTotalEntities) == "function" ? n._shouldShowTotalEntities(i, s) : !1) ? !0 : this._showAll, r = new Map(
    ...
    ), f = ((G = n == null ? void 0 : n._config) == null ? void 0 : G.ungroupAreas) === !0 || ((Bt = n == null ? void 0 : n._config) == null ? void 0 : Bt.ungroup_areas) === !0 || ((ie = n == null ? void 0 : n._config) == null ? void 0 : ie.area_grouping) !== void 0 && ((se = n == null ? void 0 : n._config) == null ? void 0 : se.area_grouping) === !1, b = p.length ? Math.max(...p.map(([, w]) => w.length)) : 0, m = f ? Math.min(t, Math.max(1, c.length)) : Math.min(t, Math.max(1, b)), _ = P(i, s), C = typeof (n == null ? void 0 : n.getCustomizationForType) == "function" ? n.getCustomizationForType(_) : void 0, y = (C == null ? void 0 : C.invert) === !0;
    return $`
      <ha-dialog
        .open=${this.open}
        hideActions
...
let T = class extends V {
  ...
  getStatusProperty(e, t, i) {
    ...
    switch (e) {
      ...
      case "lock":
      case "cover": {
        const l = I(this.hass, "open", "cover"), r = I(
          this.hass,
          "closed",
          "cover"
        );
      ...
      default: {
        if (t && s.includes(t)) {
          const c = I(this.hass, "open", "cover"), d = I(
            this.hass,
            "closed",
            "cover"
          );
  ...
  getCustomIcon(e, t, i) {
    ...
    let a = e;
    if (!t && e.includes(".") && (a = e.split(".")[0]), X && X[a]) {
      const l = X[a];
  ...
  _getIconStyles(e, t = {}) {
    const { color: i, background_color: s, square: o, isNotHome: n } = t, a = {
      ...
      "background-color": s,
      color: i ? `var(--state-${i}-color, var(--${i}-color, var(--badge-color, var(--primary-text-color, #607d8b))))` : "var(--badge-color, var(--primary-text-color, #607d8b))"
    };
        ...
        <div class="entity ${ht(h)}">
          <div class="entity-icon">
            <ha-icon icon=${this.getCustomIcon(t, i)}
              style=${"color" in u && u.color ? `color: ${u.color}` : ""}
            ></ha-icon>
          </div>
          <div class="entity-info">
            ${this.hide_content_name ? "" : $`<div class="entity-name">
...
var Hi = Object.defineProperty, Pi = Object.getOwnPropertyDescriptor, it = (e, t, i, s) => {
...
var Ii = Object.defineProperty, ji = Object.getOwnPropertyDescriptor, dt = (e, t, i, s) => {
...
let et = class extends V {
  ...
  async updated(e) {
    ...
    if (!(!this.hass || !this._config) && e.has("_config")) {
      ...
      if (!Z(d, l) || f || p) {
        ...
        const C = m.sort((y, g) => {
          const v = _.indexOf(y), F = _.indexOf(g);
          return (v === -1 ? _.length : v) - (F === -1 ? _.length : F);
        });
        this._config = {
          ...this._config,
          content: [...C]
  ...
  _classesForArea(e, t, i) {
    ...
    const a = new Set(
      o.map((d) => B(d.entity_id)).filter((d) => d !== "binary_sensor" && d !== "cover" && d !== "switch").map((d) => nt(d))
    ), l = /* @__PURE__ */ new Set();
    o.filter(
  ...
  _groupAllEntitiesByDomain() {
    ...
    ), a = this._hiddenEntitiesByDomain(), l = ((F = this.hass) == null ? void 0 : F.states) || {}, r = Array.from(
