 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: He, defineProperty: Pe, getOwnPropertyDescriptor: je, getOwnPropertyNames: Ne, getOwnPropertySymbols: Re, getPrototypeOf: Fe } = Object, tt = globalThis, re = tt.trustedTypes, Be = re ? re.emptyScript : "", Rt = tt.reactiveElementPolyfillSupport, $t = (e, t) => e, kt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Be : null;
      break;
  ...
  return i;
} }, Yt = (e, t) => !He(e, t), le = { attribute: !0, type: String, converter: kt, reflect: !1, useDefault: !1, hasChanged: Yt };
...
let pt = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty($t("properties"))) {
      const i = this.properties, s = [...Ne(i), ...Re(i)];
...
pt.elementStyles = [], pt.shadowRootOptions = { mode: "open" }, pt[$t("elementProperties")] = /* @__PURE__ */ new Map(), pt[$t("finalized")] = /* @__PURE__ */ new Map(), Rt == null || Rt({ ReactiveElement: pt }), (tt.reactiveElementVersions ?? (tt.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wt = globalThis, Dt = wt.trustedTypes, ce = Dt ? Dt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Ee = "$lit$", X = `lit$${Math.random().toFixed(9).slice(2)}$`, Ce = "?" + X, Ue = `<${Ce}>`, dt = document, At = () => dt.createComment(""), Et = (e) => e === null || typeof e != "object" && typeof e != "function", Xt = Array.isArray, Ve = (e) => Xt(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ft = `[ 	
\f\r]`, vt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, de = /-->/g, he = />/g, ot = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ue = /'/g, me = /"/g, Se = /^(?:script|style|textarea|title)$/i, qe = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), $ = qe(1), q = Symbol.for("lit-noChange"), k = Symbol.for("lit-nothing"), pe = /* @__PURE__ */ new WeakMap(), rt = dt.createTreeWalker(dt, 129);
function xe(e, t) {
...
const Ge = (e, t) => {
  ...
  for (let l = 0; l < i; l++) {
    const r = e[l];
    let c, d, h = -1, u = 0;
    for (; u < r.length && (a.lastIndex = u, d = a.exec(r), d !== null); ) u = a.lastIndex, a === vt ? d[1] === "!--" ? a = de : d[1] !== void 0 ? a = he : d[2] !== void 0 ? (Se.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = ot) : d[3] !== void 0 && (a = ot) : a === ot ? d[0] === ">" ? (a = o ?? vt, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, c = d[1], a = d[3] === void 0 ? ot : d[3] === '"' ? me : ue) : a === me || a === ue ? a = ot : a === de || a === he ? a = vt : (a = ot, o = void 0);
    const f = a === ot && e[l + 1].startsWith("/>") ? " " : "";
    n += a === vt ? r + Ue : h >= 0 ? (s.push(c), r.slice(0, h) + Ee + r.slice(h) + X + f) : r + X + (h === -2 ? l : f);
  }
...
class Ct {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const l = t.length - 1, r = this.parts, [c, d] = Ge(t, i);
    ...
    for (; (o = rt.nextNode()) !== null && r.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(Ee)) {
          ...
          r.push({ type: 1, index: n, name: m[2], strings: f, ctor: m[1] === "." ? We : m[1] === "?" ? Ze : m[1] === "@" ? Ye : Lt }), o.removeAttribute(h);
...
let Ke = class {
  ...
  u(t) {
    ...
    for (; r !== void 0; ) {
      if (a === r.index) {
        let c;
        r.type === 2 ? c = new yt(n, n.nextSibling, this, t) : r.type === 1 ? c = new r.ctor(n, r.name, r.strings, this, t) : r.type === 6 && (c = new Xe(n, this, t)), this._$AV.push(c), r = s[++l];
      }
...
const Je = { I: yt }, Bt = wt.litHtmlPolyfillSupport;
...
var we;
V._$litElement$ = !0, V.finalized = !0, (we = lt.litElementHydrateSupport) == null || we.call(lt, { LitElement: V });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jt = { ATTRIBUTE: 1, CHILD: 2 }, It = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Ht = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ze = "important", ai = " !" + ze, Z = It(class extends Ht {
  constructor(e) {
    var t;
...
var zi = Object.defineProperty, I = (e, t, i, s) => {
  for (var o = void 0, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = a(t, i, o) || o);
  return o && zi(t, i, o), o;
}, ct;
const R = (ct = class extends V {
  constructor() {
  ...
  render() {
    ...
    ), m = ((G = n == null ? void 0 : n._config) == null ? void 0 : G.ungroupAreas) === !0 || ((Nt = n == null ? void 0 : n._config) == null ? void 0 : Nt.ungroup_areas) === !0 || ((ie = n == null ? void 0 : n._config) == null ? void 0 : ie.area_grouping) !== void 0 && ((se = n == null ? void 0 : n._config) == null ? void 0 : se.area_grouping) === !1, b = f.length ? Math.max(...f.map(([, w]) => w.length)) : 0, p = m ? Math.min(t, Math.max(1, c.length)) : Math.min(t, Math.max(1, b)), _ = H(i, s), C = typeof (n == null ? void 0 : n.getCustomizationForType) == "function" ? n.getCustomizationForType(_) : void 0, v = (C == null ? void 0 : C.invert) === !0;
    return $`
      <ha-dialog
        .open=${this.open}
        hideActions
...
const ee = class ee extends V {
  ...
  render() {
    ...
    const t = this.selectedDomain || "", i = this.selectedDeviceClass, s = H(t, i), o = (l = (a = this.card) == null ? void 0 : a.getCustomizationForType) == null ? void 0 : l.call(a, s), n = (o == null ? void 0 : o.invert) === !0;
    return $`
      <ha-dialog
        .open=${this.open}
...
let T = class extends V {
  ...
  _shouldShowTotalEntities(e, t) {
    ...
    const i = H(e, t), s = this.getCustomizationForType(i);
  ...
  _isOn(e, t) {
    var n;
    const i = this._baseEntities(e, t), s = H(e, t), o = ((n = this.getCustomizationForType(s)) == null ? void 0 : n.invert) === !0;
    return i.filter((a) => {
      if (e === "climate") {
  ...
  updated(e) {
    ...
    (e.has("hass") && (!t || t.themes !== this.hass.themes) || e.has("_config") && (!i || i.theme !== this._config.theme)) && fi(
      this,
      this.hass.themes,
      this._config.theme
  ...
  getStatusProperty(e, t, i) {
    ...
    const s = [
      ...
      "shade",
      "shutter"
    ], o = H(e, t), n = this.getCustomizationForType(o), a = (n == null ? void 0 : n.invert) === !0;
    switch (e) {
      case "device_tracker": {
        const l = P(
          this.hass,
...
var Mi = Object.defineProperty, Ii = Object.getOwnPropertyDescriptor, st = (e, t, i, s) => {
...
var Hi = Object.defineProperty, Pi = Object.getOwnPropertyDescriptor, ht = (e, t, i, s) => {
